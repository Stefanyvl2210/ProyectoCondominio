  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        ...
        @endif
        <form action="/reporte_inmuebles/{{$reporte->id}}/cobros" method="post">
          @csrf
          <div class="form-group">

            <input type="hidden" name="inmueble_id" id="inmueble_id" class="form-control" value="{{$reporte->id}}">
          ...
          <table class="table">
            <tr>
              ...
              <td><a class="btn btn-secondary" href="/reporte_inmuebles/{{$reporte->id}}">Regresar</a></td>
            </tr>
          </table>
        </form>
      </div>
